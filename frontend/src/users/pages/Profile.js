...
const Profile = () => {
  ...
  const profilePlaces = places.map((place)=>{
    return <ProfilePlace key={place.id} title={place.title} subTitle={place.subTitle} description={place.description} id={place.id} address={place.address} coordinates={place.location} placeImage = {place.placeImage}/>
  })
