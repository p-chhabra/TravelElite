            ...
            <ul className="noBullet">
              <li>
                ...
                <input
                  ...
                  type="text"
                  className={
                    formValidity.username ? `inputFields` : `inputFieldInvalid`
                  }
                  id="username"
                  name="username"
              ...
              <li>
                ...
                <input
                  ...
                  type="email"
                  className={
                    formValidity.email ? `inputFields` : `inputFieldInvalid`
                  }
                  id="email"
                  name="email"
                  placeholder="Email"
              ...
              <li>
                ...
                <input
                  ...
                  type="password"
                  className={
                    formValidity.password ? `inputFields` : `inputFieldInvalid`
                  }
                  id="password"
                  name="password"
